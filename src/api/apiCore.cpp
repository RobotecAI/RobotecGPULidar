...
void TapeCore::tape_get_version_info(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_get_extension_info(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_configure_logging(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_cleanup(const YAML::Node& yamlNode, TapeState& tapeState)
{
	rgl_cleanup();
...
void TapeCore::tape_mesh_create(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_mesh_set_texture_coords(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_mesh_destroy(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_mesh_update_vertices(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_entity_create(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_entity_destroy(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_entity_set_pose(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_entity_set_id(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_entity_set_intensity_texture(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_texture_create(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_texture_destroy(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_scene_set_time(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_graph_run(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_graph_destroy(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_graph_get_result_size(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_graph_get_result_data(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_graph_node_add_child(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_graph_node_remove_child(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_graph_node_set_priority(const YAML::Node& yamlNode, TapeState& tapeState)
{
...
void TapeCore::tape_graph_node_get_priority(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.at(nodeId);
...
void TapeCore::tape_node_rays_from_mat3x4f(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
...
void TapeCore::tape_node_rays_set_ring_ids(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_rays_set_range(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_rays_set_time_offsets(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_rays_transform(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_points_transform(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_raytrace(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_raytrace_with_distortion(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_points_format(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_points_yield(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_points_compact(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_points_spatial_merge(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
...
void TapeCore::tape_node_points_temporal_merge(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes[nodeId] : nullptr;
...
void TapeCore::tape_node_points_from_array(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_gaussian_noise_angular_ray(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_gaussian_noise_angular_hitpoint(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
...
void TapeCore::tape_node_gaussian_noise_distance(const YAML::Node& yamlNode, TapeState& tapeState)
{
	auto nodeId = yamlNode[0].as<TapeAPIObjectID>();
	rgl_node_t node = tapeState.nodes.contains(nodeId) ? tapeState.nodes.at(nodeId) : nullptr;
