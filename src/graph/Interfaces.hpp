...
struct IRaysNodeSingleInput : virtual IRaysNode
{
	...
	virtual void onInputChangeImpl() override { input = Node::getValidInput<IRaysNode>(); }
...
// TODO(prybicki): This requires synchronizing with the potentially different stream provided by the execute(...)
