...
TEST_F(EntityIdTest, BaseTest)
{
	...
	spawnCubeOnScene(nullptr, {6, BOX1_Y_POS, 0}, {0, 0, 0}, {1, 1, 1}, BOX1_ID);
	spawnCubeOnScene(nullptr, {6, BOX2_Y_POS, 0}, {0, 0, 0}, {1, 1, 1}, BOX2_ID);
	spawnCubeOnScene(nullptr, {6, BOX3_Y_POS, 0}, {0, 0, 0}, {1, 1, 1});
