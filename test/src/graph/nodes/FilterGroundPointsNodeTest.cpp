...
struct FilterGroundPointsNodeTest : public RGLTest
{
	...
	static const inline auto UP_VEC = Vec3f(0, 1, 0);
...
TEST_F(FilterGroundPointsNodeTest, invalid_argument_node)
{
	...
	EXPECT_RGL_INVALID_ARGUMENT(rgl_node_points_filter_ground(&filterGroundNode, RGL_AXIS_Y, -1.0f),
...
TEST_F(FilterGroundPointsNodeTest, floor_test)
{
	...
	EXPECT_RGL_SUCCESS(rgl_node_points_compact(&compactNonHitNode));
