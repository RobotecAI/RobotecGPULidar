...
{
	EXPECT_RGL_INVALID_ARGUMENT(rgl_node_points_spatial_merge(&spatialMergePointsNode, nullptr, fields.size()),
	                            "fields != nullptr");
}
...
TEST_F(SpatialMergePointsNodeTest, spatial_merge_from_transforms)
{
...
TEST_F(SpatialMergePointsNodeTest, spatial_merge_from_raytraces)
{
	// Setup cube scene
	auto mesh = makeCubeMesh();
	auto entity = makeEntity(mesh);
