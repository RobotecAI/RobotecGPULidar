...
struct LinearGraph
{
	...
	{
		setupBoxesAlongAxes();
		useRaysNode = nullptr, raytraceNode = nullptr, transformRaysNode = nullptr, transformPointsNode = nullptr,
		compactNode = nullptr;
	...
	void RunGraph() { EXPECT_RGL_SUCCESS(rgl_graph_run(raytraceNode)); }
