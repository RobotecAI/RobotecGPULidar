...
static inline void setupThreeBoxScene(rgl_scene_t scene)
{
        ...
        rgl_mat3x4f boxATf = Mat3x4f::TRS({ 6, -5, 0 }, { 0, 0, 0, }, { 1, 1, 1 }).toRGL();
        rgl_mat3x4f boxBTf = Mat3x4f::TRS({ 6,  0, 0 }, { 0, 0, 0, }, { 1, 1, 1 }).toRGL();
        rgl_mat3x4f boxCTf = Mat3x4f::TRS({ 6,  5, 0 }, { 0, 0, 0, }, { 1, 1, 1 }).toRGL();
